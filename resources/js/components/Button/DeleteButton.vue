<template>
    ...
    <div v-if="showModal" tabindex="-1" aria-hidden="true"
         class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-800 bg-opacity-75 overflow-x-hidden overflow-y-auto h-full w-full">
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <RedButton text="削除する" @click="onClick"/>
                    <GrayButton text="キャンセル" @click="showModal = false"/>
                </div>
            </div>
        </div>
    </div>
